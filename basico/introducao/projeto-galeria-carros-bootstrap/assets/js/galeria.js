//alert("Galeria de Carros");

let listaCarros = [
    {
        "nome": "Drako GTE",
        "img": "assets/img/drako-gte.webp",
    ...
    },
    {
        ...
        "img": "assets/img/ferrari-laferrari.webp",
    ...
    {
        "nome": "Pagani Huayra",
        "img": "assets/img/pagani-huayra.webp",
    ...
    {
        "nome": "McLaren Elva",
        "img": "assets/img/mclaren-elva.webp",
    ...
    {
        "nome": "Czinger 21C",
        "img": "assets/img/czinger-21c.webp",
...
function alterarTemaSite(){
    ...
    if(tema === "dark"){
        ...
        document.querySelector("#alterar-tema").innerHTML = `<i class="bi bi-moon-fill"></i>`;
    } else{
        document.querySelector("html").setAttribute("data-bs-theme","dark");
        document.querySelector("#alterar-tema").innerHTML = `<i class="bi bi-brightness-high-fill"></i>`;
    }
}   
